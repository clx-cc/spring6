...
public class AccountDaoImpl implements AccountDao {
    ...
    public int update(Account act) {
        String sql = "update t_act set id = ? , balance = ? where actno = ?";
        int count = jdbcTemplate.update(sql, act.getId(), act.getBalance(), act.getActno());
        return count;
    }
